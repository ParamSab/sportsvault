...
export default function AppShell() {
    ...
    const renderContent = () => {
        ...
        if (viewingGame) return <GameDetailPage gameId={viewingGame} onBack={() => setViewingGame(null)} onViewProfile={(id) => id === 'login_prompt' ? navigate('profile') : setViewingProfile(id)} onRateGame={setRatingGame} />;
